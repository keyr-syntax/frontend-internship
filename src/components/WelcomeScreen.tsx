...
const examples = [
  {
    ...
    prompt: "I've been feeling really anxious lately. Can you help me calm down?",
  },
  {
      ...
      <div className="max-w-3xl w-full space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Your personal AI companion for mental health and emotional support. How are you feeling
            today?
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-4">Or try one of these examples to get started:</p>
        </div>
